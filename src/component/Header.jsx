      ...
      <AppBar position="static" sx={{backgroundColor:"black"}}>
        ...
        <Toolbar>
          ...
          <Typography variant="h6" component="div" sx={{ flexGrow: 1 ,fontWeight: "700"}}>
           <Link to={'/'} className='text-decoration-none text-white'> ResumeBulider.ai</Link>
          </Typography>
          <Typography><Link to={"/download"} className="text-decoration-none text-white me-5">History</Link></Typography>
          <Tooltip title={title}><Button color="inherit">About</Button></Tooltip>
        </Toolbar>
      </AppBar>
    </Box>
    </>
